...
class AuthenticationService {
  ...
  StreamController<BaseResponse> _baseResponseController = StreamController<BaseResponse>();
  StreamController<BaseResponse> _updateProfileBaseResponseController = StreamController<BaseResponse>();
  ...
  Future<BaseResponse> updateProfile(Map body, String userId,  String auth) async {
    BaseResponse fetchedUser = await _api.updateProfilePatient(body, userId, auth);

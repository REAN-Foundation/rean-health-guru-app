...
class GetAllStepsHistory {
  ...
  GetAllStepsHistory.fromJson(dynamic json) {
    _status = json['Status'];
...
class Data {
  Data({
      StepCountRecords? stepCountRecords,}){
    _stepCountRecords = stepCountRecords;
}

  Data.fromJson(dynamic json) {
    _stepCountRecords = json['StepCountRecords'] != null ? StepCountRecords.fromJson(json['StepCountRecords']) : null;
  }
  StepCountRecords? _stepCountRecords;

  StepCountRecords? get stepCountRecords => _stepCountRecords;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (_stepCountRecords != null) {
      map['StepCountRecords'] = _stepCountRecords?.toJson();
    }
    return map;
  }
...
class StepCountRecords {
  ...
  StepCountRecords.fromJson(dynamic json) {

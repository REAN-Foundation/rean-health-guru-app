...
class ActivityStepsView extends StatefulWidget {
  ...
  @override
  _ActivityStepsViewState createState() =>
      _ActivityStepsViewState();
}
...
class _ActivityStepsViewState extends State<ActivityStepsView> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  if (controller.text.toString().isEmpty) {
                    showToast('Please enter your steps count', context);
          ...
          children: [
            ...
            Expanded(
              ...
              child: Semantics(
                label: 'Steps ',
                readOnly: true,
                child: Text(record.stepCount.toString(),
                  style: TextStyle(
                      color: primaryColor,
                      fontSize: 14,
                      fontWeight: FontWeight.w300),
  ...
  List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    ...
    for (int i = 0; i < records.length; i++) {
      data.add(TimeSeriesSales(
          ...
          double.parse(records.elementAt(i).stepCount.toString())));
    }
  ...
  getVitalsHistory() async {
    try {
      final GetAllStepsHistory getAllActivityRecord =
      await model.getMyStepsHistory();

...
class _SummaryOfMyCarePlanViewState extends State<SummaryOfMyCarePlanView> {
                              ...
                              Stack(
                                children: <Widget>[
                                  if (currentWeek.toString() == '-1' || currentWeek.toString() == '0')
                                    ...
                                    currentWeekCount(),
                                    if(carePlanEnrollmentForPatientGlobe!
                                        .data!.patientEnrollments!
                                        .elementAt(0)
                                        .planName
                                        .toString() == "Stroke" || carePlanEnrollmentForPatientGlobe!
                                        .data!.patientEnrollments!
                                        .elementAt(0)
                                        .planName
  ...
  Widget _buildCarePlanViewFor12Weeks() {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.end,
  ...
  Widget _buildCarePlanViewFor13Weeks() {
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.end,

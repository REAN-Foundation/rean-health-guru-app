...
class LipidProfileLDLView extends StatefulWidget {
  bool allUIViewsVisible = false;

  LipidProfileLDLView(bool allUIViewsVisible) {
    this.allUIViewsVisible = allUIViewsVisible;
  }

  @override
  _LipidProfileLDLViewState createState() => _LipidProfileLDLViewState();
}

class _LipidProfileLDLViewState extends State<LipidProfileLDLView> {

...
class AddTobaccoConsumptionView extends StatefulWidget {
  String? mode;
  ...
  @override
  _MyAddTobaccoViewState createState() => _MyAddTobaccoViewState();
}

class _MyAddTobaccoViewState extends State<AddTobaccoConsumptionView> {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                color: Colors.white),
            child: Semantics(
              label: 'Add your tobacco intake in gram',
              //textField: true,
              //hint: 'Example Banana',
              child: TextFormField(
        ...
        child: ElevatedButton(
          onPressed: () {
            if (_nutritionNameController.text.trim().isEmpty) {
              showToastMsg("Please add tobacco intake", context);
            }

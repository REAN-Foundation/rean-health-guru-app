...
class _LoginWithOTPViewState extends State<LoginWithOTPView> {
  ...
  cleanAllData(){
    try {
      ...
      _sharedPrefUtils.saveBoolean('login1.8.167', false);
        ...
        children: <Widget>[
          ...
          Card(
            ...
            child: Container(
                ...
                child: getAppFlavour() == "Heart & Stroke Helper™ " ? _customMobileNumberFeild(model) : IntlPhoneField(
  ...
  Widget _customMobileNumberFeild(LoginViewModel model){

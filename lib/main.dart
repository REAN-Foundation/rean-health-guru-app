...
class MyApp extends StatelessWidget {
  bool isLogin;
  String _baseUrl = 'https://hca-bff-dev.services.tikme.app';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        home: SplashScreen(
            ...
            title: new Text('REAN Care' , style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, color: Colors.white)),

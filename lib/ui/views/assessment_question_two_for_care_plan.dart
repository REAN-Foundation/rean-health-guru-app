...
class AssessmentQuestionTwoCarePlanView extends StatefulWidget {
  ...
  @override
  _AssessmentQuestionTwoCarePlanViewState createState() => _AssessmentQuestionTwoCarePlanViewState();
}

class _AssessmentQuestionTwoCarePlanViewState extends State<AssessmentQuestionTwoCarePlanView> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16,),
            Icon(Icons.warning, size: 64, color: Colors.deepOrange,),
            SizedBox(height: 16,),
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Text(

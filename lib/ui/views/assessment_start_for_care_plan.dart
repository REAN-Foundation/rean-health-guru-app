...
class AssessmentStartCarePlanView extends StatefulWidget {
  ...
  @override
  _AssessmentStartCarePlanViewState createState() => _AssessmentStartCarePlanViewState();
}

class _AssessmentStartCarePlanViewState extends State<AssessmentStartCarePlanView> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24,),
              Icon(FontAwesomeIcons.solidThumbsUp, size: 48, color: primaryColor,),
              SizedBox(height: 24,),
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text(

...
class BiometricBloodOxygenVitalsView extends StatefulWidget {
  @override
  _BiometricBloodOxygenVitalsViewState createState() => _BiometricBloodOxygenVitalsViewState();
}

class _BiometricBloodOxygenVitalsViewState extends State<BiometricBloodOxygenVitalsView> {
            ...
            child: InkWell(
              onTap: (){
                if(_controller.text.toString().isEmpty){
                  showToast('Please enter your blood oxygen saturation');
                }else{
                  addvitals();
                }
              },
  ...
  List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    ...
    for(int i = 0 ; i < records.length ; i++){
      data.add(new TimeSeriesSales(DateTime.parse(records.elementAt(i).recordDate), double.parse(records.elementAt(i).bloodOxygenSaturation.toString())));
    }
  ...
  getVitalsHistory() async {
    try {
      GetMyVitalsHistory getMyVitalsHistory  = await model.getMyVitalsHistory('blood-oxygen-saturation');

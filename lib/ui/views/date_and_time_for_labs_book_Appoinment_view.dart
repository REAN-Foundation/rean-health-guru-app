...
class DateAndTimeForLabsBookAppoinmentView extends StatefulWidget {
  ...
  DateAndTimeForLabsBookAppoinmentView(@required this.labDetails);

  @override
  _DateAndTimeForLabsBookAppoinmentViewState createState() =>
      _DateAndTimeForLabsBookAppoinmentViewState(labDetails);
}
...
class _DateAndTimeForLabsBookAppoinmentViewState
  ...
  _DateAndTimeForLabsBookAppoinmentViewState(@required this.labDetails);
  ...
  getAvailableDoctorSlot() async {
    try {
      GetAvailableDoctorSlot getAvailableDoctorSlot = await model.getAvailableLabSlot(labDetails.userId.toString(), dateFormat.format(userSelectedDate),dateFormat.format(userSelectedDate), 'Bearer '+auth);
          ...
          child: MaterialButton(
            ...
            onPressed: () {
              ...
              if(startTime == ""){
                ...
                bookingAppoinmentsDetails.labs = labDetails;

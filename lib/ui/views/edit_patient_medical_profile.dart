...
class _EditPatientMedicalProfileViewState extends State<EditPatientMedicalProfileView> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                SizedBox(width: 24,),
                _sizedBoxHeight(),
                _textFeilds("Major Complaint", _majorComplaintController, _majorComplaintFocus, _bloodGroupFocus),
                _sizedBoxHeight(),
                _textFeilds("Blood Group", _bloodGroupController, _bloodGroupFocus, _ocupationFocus),
                _sizedBoxHeight(),
  ...
  Widget _textFeilds(String hint, TextEditingController editingController, FocusNode focusNode, FocusNode nextFocusNode){
    return TextFormField(
      ...
      textInputAction: focusNode == _obstetricHistoryFocus ? TextInputAction.done : TextInputAction.next,
      onFieldSubmitted: (term){
        focusNode != _obstetricHistoryFocus ? _fieldFocusChange(context, focusNode, nextFocusNode) : "";
      },
  ...
  _updatePatientMedicalProfile() async {
    try {
      ...
      BaseResponse baseResponse = await model.updatePatientMedicalProfile( widget.medicalProfiles.id, data);

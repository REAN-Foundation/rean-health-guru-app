...
class _PatientMedicalProfileViewState extends State<PatientMedicalProfileView> {
  ...
  final TextEditingController _majorComplaintController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return BaseWidget<PatientObservationsViewModel>(
        ...
        Scaffold(
          ...
          body: model.busy ? Center(child: CircularProgressIndicator()) :SingleChildScrollView(
            child: Padding(
                ...
                children: [
                    ...
                    children: <Widget>[
                      ...
                      Text(': ',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+replaceNull(medicalProfiles.majorAilment),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                    ...
                    children: <Widget>[
                      ...
                      Text(':',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+replaceNull(medicalProfiles.bloodGroup),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                    ...
                    children: <Widget>[
                      ...
                      Text(':',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+yesOrNo(medicalProfiles.isDiabetic),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                    ...
                    children: <Widget>[
                      ...
                      Text(':',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+yesOrNo(medicalProfiles.hasHeartAilment),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8,),
                      Expanded(
                        child: Text(''+replaceNull(medicalProfiles.maritalStatus),
                            style: TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                color: textBlack)),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8,),
                      Expanded(
                        child: Text(''+replaceNull(medicalProfiles.occupation),
                            style: TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                color: textBlack)),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8,),
                      Expanded(
                        child: Text(''+replaceNull(medicalProfiles.nationality),
                            style: TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                color: textBlack)),
                    ...
                    children: <Widget>[
                      ...
                      Text(':',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+yesOrNo(medicalProfiles.isVegetarian),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                    ...
                    children: <Widget>[
                      ...
                      Text(':',
                          style: TextStyle(
                              ...
                              color: textBlack)),
                      SizedBox(width: 8,),
                      Text(''+yesOrNo(medicalProfiles.isDrinker),
                          style: TextStyle(
                              fontSize: 16.0,
                              fontWeight: FontWeight.w500,
                              color: textBlack)),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8,),
                      Expanded(
                        child: Text(''+replaceNull(medicalProfiles.surgicalHistory),
                            style: TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                color: textBlack)),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8,),
                      Expanded(
                        child: Text(''+replaceNull(medicalProfiles.obstetricHistory),
                            style: TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                color: textBlack)),
            ...
            floatingActionButton: model.busy ? Container() : Semantics(
              ...
              child: new FloatingActionButton(
                  ...
                  onPressed: (){
                    Navigator.pushNamed(
                        context, RoutePaths.Patient_EDIT_MEDIACL_PROFILE, arguments: medicalProfiles).then((value) {
                      _getPatientMedicalProfile();
                    });
                  }
              ),
  ...
  _getPatientMedicalProfile() async {
    try {
      PatientMedicalProfilePojo allergiesPojo = await model.getPatientMedicalProfile('Bearer ' + auth, patientUserId);
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              _textFeilds("Major Complaint", _majorComplaintController, _majorComplaintFocus, _ocupationFocus),
                              _textFeilds("Occupation", _ocupationController, _ocupationFocus, _nationalityFocus),
                              _textFeilds("Nationality", _nationalityController, _nationalityFocus, _surgicalHistoryFocus),
                              _textFeilds("Surgical history", _surgicalHistoryController, _surgicalHistoryFocus, _obstetricHistoryFocus),
                              _textFeilds("Obstetric history", _obstetricHistoryController, _obstetricHistoryFocus, _obstetricHistoryFocus),
                            ],
                          ),
                        ),
                      ),

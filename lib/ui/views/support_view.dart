                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                       /* final Uri _emailLaunchUri = Uri(
                                        ...
                                        var link = 'mailto:'+email+'?subject=Regarding%20REAN%20HealthGuru%20App&body=Hey Team,%20\n\n'+name+'%20wants%20to%20get%20in%20touch%20with%20you.\n\nContact%20Number:%20'+userPhone+'\n\n';
                                        if (await canLaunch(link.toString())) {
                                          ...
                                          final Uri _emailLaunchUri = Uri(
                                              ...
                                              path: email,
                                              queryParameters: {
                                                'subject': 'REAN HealthGuru app query',
                                                'body': ''
                                          ...
                                          debugPrint('Could not launch ${link.toString()}');

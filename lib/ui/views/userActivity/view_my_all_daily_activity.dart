        ...
        child: CircularPercentIndicator(
          ...
          header: Column(
            children: [
              ...
              Text(
                'Here is your step details',
                semanticsLabel: 'Here is your step details',
                style: TextStyle(
                    fontFamily: "Montserrat",
      ...
      child: Align(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Here is your exercise details',
              semanticsLabel: 'Here is your exercise details',
              style: TextStyle(
                  fontFamily: "Montserrat",
                  fontWeight: FontWeight.w500,
                  fontSize: 16.0,
      ...
      child: Align(
        ...
        child: Column(
          children: [
            ...
            Text(
                Conversion.durationToString(sleepData.getSleepDuration().abs()),
                semanticsLabel: Conversion.durationToString(
      ...
      child: Align(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Here is your burned calories details',
              semanticsLabel: 'Here is your burned calories details',
              style: TextStyle(
                  fontFamily: "Montserrat",
                  fontWeight: FontWeight.w500,
                  fontSize: 16.0,

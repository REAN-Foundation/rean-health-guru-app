  ...
  Widget weekSelector(){
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.arrow_left, color: primaryColor, size: 48,),
          SizedBox(width: 100, height: 48, child: Center(child: Text('3rd Week'))),
          Icon(Icons.arrow_right, color: primaryColor, size: 48,),
        ],
      ),
    );
  }
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  "Mood Indicator",
                  style: TextStyle( color: primaryColor,fontSize: 12, fontWeight: FontWeight.w700), maxLines: 1, overflow: TextOverflow.ellipsis,
                ),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Icon(Icons.message, color: primaryColor, size: 24,),
              const SizedBox(width: 8,),
              Text(
                "Message Today",
                style: TextStyle( color: primaryColor,fontSize: 12, fontWeight: FontWeight.w700), maxLines: 1, overflow: TextOverflow.ellipsis,
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Image.asset(
                'res/images/ic_challenge.png', width: 24, height: 24,
              ),
              const SizedBox(width: 8,),
              Text(
                "Challenge",
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Image.asset(
                'res/images/ic_mindful_moment.png', width: 24, height: 24,
              ),
              const SizedBox(width: 8,),
              Text(
                "Mindful Moment",
              ...
              Expanded(
                child: Container(
                  ...
                  child: Icon(Icons.play_arrow, color: primaryColor, size: 24,),
                ),
              )
              /*Text(
                "How do I feel?",
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Image.asset(
                'res/images/ic_dictionary.png', width: 24, height: 24,
              ),
              const SizedBox(width: 8,),
              Text(
                "Word for the week!",
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Icon(Icons.videocam, color: primaryColor, size: 24,),
              const SizedBox(width: 8,),
              Text(

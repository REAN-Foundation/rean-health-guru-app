...
class GetAllConfigrations{
  ...
  _getMedicationDosageUnits() async {
    ...
    var response = await apiProvider.get('/types/medication-dosage-units', header: map);
  ...
  _getMedicationFrequencies() async {
    ...
    map["Content-Type"] = "application/json";
    map["authorization"] = 'Bearer '+auth;
    var response = await apiProvider.get('/types/medication-frequency-units', header: map);
  ...
  _getMedicationDurationUnits() async {
    ...
    map["Content-Type"] = "application/json";
    map["authorization"] = 'Bearer '+auth;
    var response = await apiProvider.get('/types/medication-duration-units', header: map);
  ...
  _getAllLabSamples() async {
    ...
    map["Content-Type"] = "application/json";
    map["authorization"] = 'Bearer '+auth;
    var response = await apiProvider.get('/types/pathology-samples', header: map);
    print(response);
